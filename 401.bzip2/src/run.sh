...
INPUT='/u/hshah/liberty-projects/nightly-regression/401.bzip2/spec_ref1/in/'
FILE='chicken.jpg'
FILE2='chicken2.jpg'

OUTPUT='/u/hshah/nightly-regression/401.bzip2/spec_ref1/in/'
...
opt -profile-loader -load ~/llvm-liberty-objects/Debug+Asserts/lib/HKTailDuplication.so -HKtaildupl main.bc -o mainnew.bc
